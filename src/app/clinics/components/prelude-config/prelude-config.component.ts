...
export class PreludeConfigComponent implements OnInit {
  ...
  mandatoryFieldNames = ["External Patient ID", "Pet Name", "Breed", "Pet Parent Last Name", "Pet Parent Email", "Secondary Email", "Baseline Start Date", "Baseline End Date", "Treatment Start Date", "Treatment End Date", "Study Group", "Address Line 1", "City", "State", "Zipcode"];
  studyName: any;
  formFiledList: any[];
